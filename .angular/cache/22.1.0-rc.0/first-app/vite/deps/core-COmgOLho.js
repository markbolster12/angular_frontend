...
var VERSION = /* @__PURE__ */ new Version("22.1.0-rc.0");
...
function getUrlSanitizer(tag, prop) {
	return RESOURCE_MAP[tag.toLowerCase()]?.[prop.toLowerCase()] === true ? ɵɵsanitizeResourceUrl : ɵɵsanitizeUrl;
}
...
function ɵɵvalidateAttribute(value, tagName, attributeName) {
	...
	const validationConfig = SECURITY_SENSITIVE_ELEMENTS[lowerCaseTagName[0] !== ":" && tNode?.namespace ? `:${tNode.namespace}:${lowerCaseTagName}` : lowerCaseTagName]?.[lowerCaseAttrName];
	if (!validationConfig) return value;
	const lView = getLView();
	if (tNode && lowerCaseTagName === "iframe") enforceIframeSecurity(getNativeByTNode(tNode, lView));
	const displayTagName = tagName[0] === ":" ? tagName.split(":").pop() : tagName;
	if (typeof validationConfig !== "boolean") {
		if (!tNode) throw new RuntimeError(-910, ngDevMode && `Angular has detected that the \`${attributeName}\` was applied as a binding to the <${tagName}> element. For security reasons, the \`${attributeName}\` can be set on the <${tagName}> element as a static attribute only. \nTo fix this, switch the \`${attributeName}\` binding to a static attribute in a template or in host bindings section.`);
		const attributeNameValue = getSecuritySensitiveSVGAnimationAttributeName(getNativeByTNode(tNode, lView), validationConfig);
	...
	throw new RuntimeError(-910, ngDevMode && `Angular has detected that the \`${attributeName}\` was applied as a binding to the <${displayTagName}> element${tNode ? getTemplateLocationDetails(lView) : ""}. For security reasons, the \`${attributeName}\` can be set on the <${displayTagName}> element as a static attribute only. \nTo fix this, switch the \`${attributeName}\` binding to a static attribute in a template or in host bindings section.`);
}
...
function createHostElement(componentDef, renderer) {
	...
	return createElementNode(renderer, tagName, tagName === "svg" ? "svg" : tagName === "math" ? MATH_ML_NAMESPACE$1 : null);
}
...
function createRootTView(rootSelectorOrNode, componentDef, componentBindings, directives) {
	const tAttributes = rootSelectorOrNode ? ["ng-version", "22.1.0-rc.0"] : extractAttrsAndClassesFromSelector(componentDef.selectors[0]);
...
function getBaseDocUrl() {
	const full = VERSION.full;
	return `https://${full.includes("-next") || full.includes("-rc") || full === "22.1.0-rc.0" ? "next" : `v${VERSION.major}`}.angular.dev`;
}
...
//#endregion
export { isDevMode as $, ɵɵdeferWhen as $a, effect as $c, ɵgetUnknownElementStrictMode as $i, __generator as $l, Output as $n, ɵɵpipeBind2 as $o, findLocaleData as $r, ɵɵtextInterpolateV as $s, AfterRenderManager as $t, contentChild as A, ɵɵdefer as Aa, NG_INJ_DEF as Ac, provideZonelessChangeDetection as Ai, ɵɵnamespaceHTML as Al, HydrationStatus as An, ɵɵi18nApply as Ao, _sanitizeHtml as Ar, ɵɵsanitizeScript as As, ɵɵngDeclareInjector as At, destroyPlatform as B, ɵɵdeferOnHover as Ba, PendingTasksInternal as Bc, resolveComponentResources as Bi, Observable as Bl, LOCALE_ID as Bn, ɵɵinterpolate3 as Bo, bypassSanitizationTrustStyle as Br, ɵɵsyntheticHostProperty as Bs, computed as Bt, ViewChildren as C, ɵɵconditionalBranchCreate as Ca, INJECTOR_SCOPE as Cc, noSideEffects as Ci, ɵunwrapWritableSignal as Cl, DeferBlockState as Cn, ɵɵforeignContent as Co, TracingAction as Cr, ɵɵrepeaterTrackByIndex as Cs, ɵassertType as Ct, assertPlatform as D, ɵɵcontrol as Da, NG_COMP_DEF as Dc, provideAppInitializer as Di, ɵɵenableBindings as Dl, Host as Dn, ɵɵgetInheritedFactory as Do, ViewContainerRef as Dr, ɵɵresolveWindow as Ds, ɵɵngDeclareDirective as Dt, annotateForHydration as E, ɵɵcontentQuerySignal as Ea, Injector as Ec, performanceMarkFeature as Ei, ɵɵdisableBindings as El, ElementRef as En, ɵɵgetCurrentView as Eo, USE_PENDING_TASKS as Er, ɵɵresolveDocument as Es, ɵɵngDeclareComponent as Et, createPlatformFactory as F, ɵɵdeferHydrateOnImmediate as Fa, NoopNgZone as Fc, registerNgModuleType as Fi, map as Fl, Injectable as Fn, ɵɵi18nStart as Fo, allowSanitizationBypassAndThrow as Fr, ɵɵsetNgModuleScope as Fs, OutputEmitterRef as Ft, getModuleFactory as G, ɵɵdeferOnViewport as Ga, Version as Gc, setDocument as Gi, reportUnhandledError as Gl, NO_CHANGE as Gn, ɵɵinterpolate8 as Go, compileNgModule as Gr, ɵɵtextInterpolate1 as Gs, resource as Gt, enableProdMode as H, ɵɵdeferOnImmediate as Ha, RuntimeError as Hc, setAllowDuplicateNgModuleIdsForTest as Hi, identity as Hl, MAX_ANIMATION_TIMEOUT as Hn, ɵɵinterpolate5 as Ho, clearResolutionOfComponentResourcesQueue as Hr, ɵɵtemplateRefExtractor as Hs, getOutputDestroyRef as Ht, debounced as I, ɵɵdeferHydrateOnInteraction as Ia, PLATFORM_ID as Ic, renderDeferBlockState as Ii, BehaviorSubject as Il, Input as In, ɵɵinjectAttribute as Io, asNativeElements as Ir, ɵɵstoreLet as Is, ResourceDependencyError as It, injectAsync as J, ɵɵdeferPrefetchOnImmediate as Ja, _global as Jc, transitiveScopesFor as Ji, isFunction as Jl, NgModuleFactory as Jn, ɵɵlistener as Jo, createEnvironmentInjector as Jr, ɵɵtextInterpolate4 as Js, ANIMATIONS_DISABLED as Jt, getNgModuleById as K, ɵɵdeferPrefetchOnHover as Ka, XSS_SECURITY_URL as Kc, setLocaleId as Ki, Subscription as Kl, NO_ERRORS_SCHEMA as Kn, ɵɵinterpolateV as Ko, compileNgModuleDefs as Kr, ɵɵtextInterpolate2 as Ks, setInParamsFunction as Kt, declareExperimentalWebMcpTool as L, ɵɵdeferHydrateOnTimer as La, PLATFORM_INITIALIZER as Lc, resetCompiledComponents as Li, Subject as Ll, JSACTION_BLOCK_ELEMENT_MAP as Ln, ɵɵinterpolate as Lo, bypassSanitizationTrustHtml as Lr, ɵɵstyleMap as Ls, ResourceImpl as Lt, createComponent as M, ɵɵdeferHydrateNever as Ma, NG_PIPE_DEF as Mc, publishNonCoreGlobalUtil as Mi, ɵɵnamespaceSVG as Ml, IS_HYDRATION_DOM_REUSE_ENABLED as Mn, ɵɵi18nEnd as Mo, afterEveryRender as Mr, ɵɵsanitizeUrl as Ms, ɵɵngDeclarePipe as Mt, createOrReusePlatformInjector as N, ɵɵdeferHydrateOnHover as Na, NG_PROV_DEF as Nc, readHydrationInfo as Ni, ɵɵresetView as Nl, IS_INCREMENTAL_HYDRATION_ENABLED as Nn, ɵɵi18nExp as No, afterNextRender as Nr, ɵɵsanitizeUrlOrResourceUrl as Ns, ɵɵngDeclareService as Nt, booleanAttribute as O, ɵɵcontrolCreate as Oa, NG_DIR_DEF as Oc, provideIdleServiceWith as Oi, ɵɵinject as Ol, HostBinding as On, ɵɵgetReplaceMetadataURL as Oo, ViewEncapsulation$1 as Or, ɵɵsanitizeHtml as Os, ɵɵngDeclareFactory as Ot, createPlatform as P, ɵɵdeferHydrateOnIdle as Pa, NgZone as Pc, registerLocaleData as Pi, ɵɵrestoreView as Pl, Inject as Pn, ɵɵi18nPostprocess as Po, allLeavingAnimations as Pr, ɵɵsetComponentScope as Ps, CACHE_ACTIVE as Pt, internalProvideZoneChangeDetection as Q, ɵɵdeferPrefetchWhen as Qa, createInjector as Qc, unwrapSafeValue as Qi, __awaiter as Ql, Optional as Qn, ɵɵpipeBind1 as Qo, enableProfiling$1 as Qr, ɵɵtextInterpolate8 as Qs, AcxViewEncapsulation as Qt, defaultIterableDiffers as R, ɵɵdeferHydrateOnViewport as Ra, PROVIDED_ZONELESS as Rc, resetIncrementalHydrationEnabledWarnedForTests as Ri, createOperatorSubscriber as Rl, JSACTION_EVENT_CONTRACT as Rn, ɵɵinterpolate1 as Ro, bypassSanitizationTrustResourceUrl as Rr, ɵɵstyleProp as Rs, ResourceParamsStatus as Rt, ViewChild as S, ɵɵconditional as Sa, INJECTOR$1 as Sc, markForRefresh as Si, truncateMiddle as Sl, DeferBlockBehavior as Sn, ɵɵforeignComponent as So, TimerScheduler as Sr, ɵɵrepeaterTrackByIdentity as Ss, ɵINPUT_SIGNAL_BRAND_WRITE_TYPE as St, afterRenderEffect as T, ɵɵcontentQuery as Ta, InjectionToken as Tc, patchComponentDefWithScope as Ti, ɵɵdefineInjector as Tl, EVENT_REPLAY_QUEUE as Tn, ɵɵgetComponentDepsFactory as To, Type as Tr, ɵɵresolveBody as Ts, ɵɵngDeclareClassMetadataAsync as Tt, enableProfiling as U, ɵɵdeferOnInteraction as Ua, TransferState as Uc, setClassMetadata as Ui, observable as Ul, MissingTranslationStrategy as Un, ɵɵinterpolate6 as Uo, compileComponent as Ur, ɵɵtext as Us, isInParamsFunction as Ut, disableProfiling as V, ɵɵdeferOnIdle as Va, R3Injector as Vc, restoreComponentResolutionQueue as Vi, pipe as Vl, LocaleDataIndex as Vn, ɵɵinterpolate4 as Vo, bypassSanitizationTrustUrl as Vr, ɵɵtemplate as Vs, encapsulateResourceError as Vt, getCurrentClosestComponentInstance as W, ɵɵdeferOnTimer as Wa, VERSION as Wc, setClassMetadataAsync as Wi, noop$1 as Wl, NOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR as Wn, ɵɵinterpolate7 as Wo, compileDirective as Wr, ɵɵtextInterpolate as Ws, linkedSignal as Wt, input as X, ɵɵdeferPrefetchOnTimer as Xa, assertNotInReactiveContext as Xc, twoWayBinding as Xi, __asyncValues as Xl, NgModuleRef as Xn, ɵɵnextContext as Xo, depsTracker as Xr, ɵɵtextInterpolate6 as Xs, APP_INITIALIZER as Xt, injectChangeDetectorRef as Y, ɵɵdeferPrefetchOnInteraction as Ya, assertInInjectionContext as Yc, triggerResourceLoading as Yi, __asyncGenerator as Yl, NgModuleFactory$1 as Yn, ɵɵloadQuery as Yo, createNgModule as Yr, ɵɵtextInterpolate5 as Ys, APP_BOOTSTRAP_LISTENER as Yt, internalCreateApplication as Z, ɵɵdeferPrefetchOnViewport as Za, convertToBitFlags as Zc, unregisterAllLocaleData as Zi, __await as Zl, NgModuleRef$1 as Zn, ɵɵpipe as Zo, devModeEqual as Zr, ɵɵtextInterpolate7 as Zs, AcxChangeDetectionStrategy as Zt, PlatformRef as _, ɵɵattachSourceLocations as _a, EnvironmentInjector as _c, isComponentDefPendingResolution as _i, runInInjectionContext as _l, DEFER_BLOCK_DEPENDENCY_INTERCEPTOR as _n, ɵɵelementContainerEnd as _o, TRANSLATIONS as _r, ɵɵqueryRefresh as _s, viewChildren as _t, ContentChildren as a, ɵɵExternalStylesFeature as aa, ɵɵvalidateAttribute as ac, getDebugNode as ai, inject as al, ChangeDetectionStrategy as an, ɵɵdirectiveInject as ao, RendererFactory2 as ar, ɵɵproperty as as, output as at, SIGNAL as au, REQUEST_CONTEXT as b, ɵɵclassProp as ba, IMAGE_CONFIG as bc, isSubscribable as bi, store as bl, DebugEventListener as bn, ɵɵelementStart as bo, Testability as br, ɵɵrepeater as bs, withI18nSupport as bt, EmbeddedViewRef as c, ɵɵNgOnChangesFeature as ca, ANIMATION_MODULE_TYPE as cc, getDocument as ci, isSignal as cl, Component as cn, ɵɵdomElementContainerEnd as co, SSR_CONTENT_INTEGRITY_MARKER as cr, ɵɵpureFunction2 as cs, provideExperimentalWebMcpTools as ct, HOST_TAG_NAME as d, ɵɵanimateEnter as da, CSP_NONCE as dc, getLocaleCurrencyCode as di, makeEnvironmentProviders as dl, ComponentRef$1 as dn, ɵɵdomElementStart as do, Self as dr, ɵɵpureFunction5 as ds, provideZoneChangeDetection as dt, ɵgetUnknownPropertyStrictMode as ea, ɵɵtrustConstantHtml as ec, flushModuleScopingQueueAsMuchAsPossible as ei, formatRuntimeError as el, ApplicationInitStatus as en, ɵɵdefineComponent as eo, Pipe as er, ɵɵpipeBind3 as es, maybeUnwrapDefaultExport as et, __read as eu, HostAttributeToken as f, ɵɵanimateEnterListener as fa, ChangeDetectionScheduler as fc, getLocalePluralCase as fi, makeStateKey as fl, Console as fn, ɵɵdomListener as fo, Service as fr, ɵɵpureFunction6 as fs, reflectComponentType as ft, PROVIDED_NG_ZONE as g, ɵɵarrowFunction as ga, EffectScheduler as gc, inputBinding as gi, resolveForwardRef as gl, DEFER_BLOCK_CONFIG as gn, ɵɵelementContainer as go, TESTABILITY_GETTER as gr, ɵɵqueryAdvance as gs, viewChild as gt, PERFORMANCE_MARK_PREFIX as h, ɵɵariaProperty as ha, ENVIRONMENT_INITIALIZER as hc, inferTagNameFromDefinition as hi, provideEnvironmentInitializer as hl, DEFAULT_LOCALE_ID as hn, ɵɵelement as ho, TESTABILITY as hr, ɵɵpureFunctionV as hs, stopMeasuring as ht, ContentChild as i, ɵɵControlFeature as ia, ɵɵtwoWayProperty as ic, getComponentInstanceDeepLinkId as ii, importProvidersFrom as il, CUSTOM_ELEMENTS_SCHEMA as in, ɵɵdefineService as io, Renderer2 as ir, ɵɵprojectionDef as is, onIdle as it, setCurrentInjector as iu, contentChildren as j, ɵɵdeferEnableTimerScheduling as ja, NG_MOD_DEF as jc, provideZonelessChangeDetectionInternal as ji, ɵɵnamespaceMathML as jl, IS_ENABLED_BLOCKING_INITIAL_NAVIGATION as jn, ɵɵi18nAttributes as jo, _sanitizeUrl as jr, ɵɵsanitizeStyle as js, ɵɵngDeclareNgModule as jt, compileNgModuleFactory as k, ɵɵdeclareLet as ka, NG_ELEMENT_ID as kc, provideNgReflectAttributes as ki, ɵɵinvalidFactoryDep as kl, HostListener as kn, ɵɵi18n as ko, ViewRef$1 as kr, ɵɵsanitizeResourceUrl as ks, ɵɵngDeclareInjectable as kt, FactoryTarget as l, ɵɵProvidersFeature as la, APP_ID as lc, getHostElement as li, isStandalone as ll, ComponentFactory as ln, ɵɵdomElementContainerStart as lo, Sanitizer as lr, ɵɵpureFunction3 as ls, providePlatformInitializer as lt, KeyValueDiffers as m, ɵɵanimateLeaveListener as ma, DestroyRef as mc, getTransferState as mi, provideBrowserGlobalErrorListeners as ml, DEFAULT_CURRENCY_CODE as mn, ɵɵdomTemplate as mo, SkipSelf as mr, ɵɵpureFunction8 as ms, startMeasuring as mt, CLIENT_RENDER_MODE_FLAG as n, ɵsetUnknownElementStrictMode as na, ɵɵtwoWayBindingSet as nc, getAsyncClassMetadataFn as ni, getComponentDef as nl, Attribute as nn, ɵɵdefineNgModule as no, QueryList as nr, ɵɵpipeBindV as ns, model as nt, __values as nu, DefaultIterableDiffer as o, ɵɵHostDirectivesFeature as oa, ɵɵviewQuery as oc, getDeferBlocks as oi, isEnvironmentProviders as ol, Compiler as on, ɵɵdomElement as oo, RendererStyleFlags2 as or, ɵɵpureFunction0 as os, platformCore as ot, IterableDiffers as p, ɵɵanimateLeave as pa, DOCUMENT$1 as pc, getSanitizationBypassType as pi, promiseWithResolvers as pl, ControlFlowBlockType as pn, ɵɵdomProperty as po, SimpleChange as pr, ɵɵpureFunction7 as ps, resourceFromSnapshots as pt, getPlatform as q, ɵɵdeferPrefetchOnIdle as qa, ZONELESS_ENABLED as qc, setTestabilityGetter as qi, createErrorClass as ql, NgModule as qn, ɵɵinvalidFactory as qo, compilePipe as qr, ɵɵtextInterpolate3 as qs, untracked as qt, ChangeDetectorRef as r, ɵsetUnknownPropertyStrictMode as ra, ɵɵtwoWayListener as rc, getClosestComponentName as ri, getInjectableDef as rl, COMPILER_OPTIONS as rn, ɵɵdefinePipe as ro, ReflectionCapabilities as rr, ɵɵprojection as rs, numberAttribute as rt, setAlternateWeakRefImpl as ru, ENABLE_ROOT_COMPONENT_BOOTSTRAP as s, ɵɵInheritDefinitionFeature as sa, ɵɵviewQuerySignal as sc, getDirectives as si, isInjectable as sl, CompilerFactory as sn, ɵɵdomElementContainer as so, SHARED_STYLES_HOST as sr, ɵɵpureFunction1 as ss, provideCheckNoChangesConfig as st, ApplicationModule as t, ɵsetClassDebugInfo as ta, ɵɵtrustConstantResourceUrl as tc, generateStandaloneInDeclarationsError as ti, forwardRef as tl, ApplicationRef as tn, ɵɵdefineDirective as to, ProfilerEvent as tr, ɵɵpipeBind4 as ts, mergeApplicationConfig as tt, __spreadArray as tu, Framework as u, ɵɵadvance as ua, CONTAINER_HEADER_OFFSET as uc, getLContext as ui, isWritableSignal as ul, ComponentRef as un, ɵɵdomElementEnd as uo, SecurityContext as ur, ɵɵpureFunction4 as us, provideStabilityDebugging as ut, Query as v, ɵɵattribute as va, ErrorHandler as vc, isNgModule as vi, setInjectorProfilerContext as vl, DEHYDRATED_BLOCK_REGISTRY as vn, ɵɵelementContainerStart as vo, TRANSLATIONS_FORMAT as vr, ɵɵreadContextLet as vs, withDomHydration as vt, ViewRef as w, ɵɵconditionalCreate as wa, INTERNAL_APPLICATION_ERROR_HANDLER as wc, outputBinding as wi, ɵɵdefineInjectable as wl, Directive as wn, ɵɵforeignContentFn as wo, TracingService as wr, ɵɵreplaceMetadata as ws, ɵɵngDeclareClassMetadata as wt, RESPONSE_INIT as x, ɵɵcomponentInstance as xa, IMAGE_CONFIG_DEFAULTS as xc, isViewDirty as xi, stringify as xl, DebugNode as xn, ɵɵenableIncrementalHydrationRuntime as xo, TestabilityRegistry as xr, ɵɵrepeaterCreate as xs, withIncrementalHydration as xt, REQUEST as y, ɵɵclassMap as ya, EventEmitter as yc, isPromise as yi, signal as yl, DebugElement as yn, ɵɵelementEnd as yo, TemplateRef as yr, ɵɵreference as ys, withEventReplay as yt, defaultKeyValueDiffers as z, ɵɵdeferHydrateWhen as za, PendingTasks as zc, resetJitOptions as zi, operate as zl, LContext as zn, ɵɵinterpolate2 as zo, bypassSanitizationTrustScript as zr, ɵɵsyntheticHostListener as zs, chain as zt };
